...
def preprocess(metrics, recalculate=False, causal=False):
    ...
    if recalculate:
        ...
        try:
            training_data = np.load("./Broward_Data/COMPAS_train_data.npy")
            training_labels = np.load("./Broward_Data/COMPAS_train_labels.npy")
            test_data = np.load("./Broward_Data/COMPAS_test_data.npy")
            test_labels = np.load("./Broward_Data/COMPAS_test_labels.npy")
